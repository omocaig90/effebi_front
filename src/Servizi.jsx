        ...
        <div className="servizi-boxes-wrapper">
          <div className="servizi-boxes">
            <div className="servizio-box">
              <FontAwesomeIcon icon={faCar} size="2x" color="#D9534F" />
              <h2>INSTALLAZIONE DI GANCI TRAINO</h2>
              <p>Su autoveicoli, furgoni e camper.</p>
            </div>
            <div className="servizio-box">
              <FontAwesomeIcon icon={faWrench} size="2x" color="#D9534F" />
            ...
            <div className="servizio-box">
              <FontAwesomeIcon icon={faBicycle} size="2x" color="#D9534F" />
            ...
            <div className="servizio-box">
              <FontAwesomeIcon icon={faClipboardCheck} size="2x" color="#D9534F" />
